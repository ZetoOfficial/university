...
namespace lab10
{
    public partial class Form1 : Form
    {
        ...
        private void DrawSquarePicture(float a, int k)
        {
            ...
            var color = radioButton1.Checked ? "–азличный" : $"ћонохромный ({myPenColor})";
            inmormationSquare = $" вадрат, a={a}, k={k}, line={color}";
        ...
        private void DrawSnowPicture(float R, float delta, int k, int m)
        {
            var myPen = new Pen(myPenColor, 2f);
            var color = radioButton1.Checked ? "–азличный" : $"ћонохромный ({myPenColor})";
            informationSnow = $"—неговик, R={R}, Delta={delta}, k={k}, m={m}, line={color}";
        ...
        private void ReDrawSquarePicture()
        {
            ...
            if (this.Size.Width < 10 || this.Size.Height < 10) return;
        ...
        private void вкл¬ыкл–ежимјвтоматическойѕерерисовкиѕри»змѕараметровToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void вкл¬ыклѕринудительнуюѕерерисовкуѕри»зм‘ормыToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        string inmormationSquare = " вадрат";
        string informationSnow = "—неговик";

        private void сохранить»зображение¬bmpToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        {
            tabControl1.Size = new Size(this.Size.Width - 20, this.Size.Height - 70);
            squarePictureBox.Size = new Size((int)(this.Size.Width * (1 - 0.25f)), (int)(this.Size.Height - 70));
            squareOptionsPanel.Location = new Point(squarePictureBox.Size.Width, 0);

            snowPictureBox.Size = new Size((int)(this.Size.Width * (1 - 0.25f)), (int)(this.Size.Height - 70));
            snowPanel.Location = new Point(squarePictureBox.Size.Width, 0);

            watchPictureBox.Size = new Size((int)(this.Size.Width * (1 - 0.25f)), (int)(this.Size.Height - 70));
            watchPanel.Location = new Point(squarePictureBox.Size.Width, 0);
            if (((ToolStripMenuItem)contextMenuStrip1.Items[0]).Checked || ((ToolStripMenuItem)contextMenuStrip1.Items[1]).Checked)
            {
                ReDrawSquarePicture();
                ReDrawSnowPicture();
            }
        ...
        private void changePenColorBttn_Click(object sender, EventArgs e)
        {
            ...
            {
                myPenColor = Color.FromName((string)colorComboBox1.SelectedItem);
            }
            ReDrawSquarePicture();
            ReDrawSnowPicture();
            ReDrawWatchPicture();
