...
namespace L4
{
    class Program
    {
        ...
        static void Serialize(List<Vehicle> vehicles)
        {
        ...
        static List<Vehicle> Deserialize()
        {
            try
            {
        ...
        static void Add(List<Vehicle> vehicles) // метод добавления элемента в список, список передается в качестве параметра
        {
            Console.Clear();
        ...
        static void Remove(List<Vehicle> vehicles)// метод для удаления из списка
        ...
        static void WorkWithObject(List<Vehicle> vehicles)
        {
        ...
        {
            List<Vehicle> vehicles = Deserialize();
            try
            {
            ...
            Serialize(vehicles); // в конце работы сохраняем список в файл
        }
    }
}
